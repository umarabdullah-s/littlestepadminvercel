...
export const getAttendanceCorrectionRequests = (page = 1) => {
  return apiService.get(`/request/admin?page=${page}`);
};

export const respondAttendanceCorrectionRequest = (id, data) => {
  return apiService.put(`/request/${id}/respond`, data);
};

export const updateAttendanceByAdmin = (attendanceId, data) => {
  return apiService.put(`/attendance/admin/${attendanceId}`, data);
};
